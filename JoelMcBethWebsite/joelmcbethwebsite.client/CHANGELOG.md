...
- Create Angular project with ng: `ng new joelmcbethwebsite.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`joelmcbethwebsite.client.esproj`).
